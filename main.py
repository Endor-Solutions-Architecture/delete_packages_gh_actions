...
def main():
    parser = argparse.ArgumentParser(description="Fetch and potentially delete GitHub Actions packages.")
    parser.add_argument('--no-dry-run', action='store_true', help="Fetch and delete all identified GitHub Actions packages.")
    ...
    if args.no_dry_run:
        ...
        print("Dry run mode: No packages will be deleted. To delete all identified GitHub Actions packages, run the script with the --no-dry-run flag.")
